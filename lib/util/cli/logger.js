...
util.cli.Logger = function() {
  ...
  /**
   * @type {util.cli.ILogCollector}
   */
  this.__collector = util.cli.NULL_COLLECTOR;
};
...
/**
 * @param {util.cli.ILogCollector} collector
 */
util.cli.Logger.prototype.setCollector = function(collector) {
...
util.cli.Logger.prototype.__info = function() {
  ...
  this.__collector.info.apply(this.__collector, arguments);
};
...
util.cli.Logger.prototype.__warn = function() {
  this.__level > 1 && console.log.apply(console,
      util.cli.Logger.__getArgs('WARNING', arguments));
  this.__collector.warn.apply(this.__collector, arguments);
};
...
util.cli.Logger.prototype.__error = function() {
  ...
  this.__collector.error.apply(this.__collector, arguments);
};
