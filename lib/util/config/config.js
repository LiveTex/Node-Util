...
util.config.load = function(filename) {
  try {
    var config = util.decodeJson(fs.readFileSync(filename)) || {};
 ...
 * @this {*}
 *
 * @param {!Array.<string>} pathArguments
 * @param {(string|number|boolean|!Array|!Object)} defaultValue
 * @return {(string|number|boolean|!Array|!Object)}
 */
util.config.getConfig = function(pathArguments, defaultValue) {
  if (typeof defaultValue === 'string') {
    return util.config.getString.apply(this, pathArguments) || defaultValue;
  } else if (typeof defaultValue === 'number') {
    return util.config.getNumber.apply(this, pathArguments) || defaultValue;
  } else if (typeof defaultValue === 'boolean') {
    return util.config.getBoolean.apply(this, pathArguments) || defaultValue;
  } else if (defaultValue instanceof Array) {
    return util.config.getArray.apply(this, pathArguments) || defaultValue;
  } else {
    return util.config.getObject.apply(this, pathArguments) || defaultValue;
  }
};
